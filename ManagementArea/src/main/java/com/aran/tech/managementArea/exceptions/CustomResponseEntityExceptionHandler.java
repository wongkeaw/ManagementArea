...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public final ResponseEntity<Object> handleMyFileNotFoundException(FileNotFoundException ex, WebRequest request){
    	FileNotFoundResponse exceptionResponse = new FileNotFoundResponse(ex.getMessage());
